...
hold on
v1=table_to_use.tssDistGene1(logical(has_tag_idx.*qtn_idx.*(table_to_use.upstreamGene1==1)));
v2=abs(table_to_use.deltaDeltaZ(logical(has_tag_idx.*qtn_idx.*(table_to_use.upstreamGene1==1))));
scatter(v1,v2,50,'filled','MarkerFaceAlpha',0.5,'MarkerFaceColor',grey)


ase_idx=table_to_use.hasAseRad==1;

v1=table_to_use.tssDistGene1(logical(ase_idx.*qtn_idx.*(table_to_use.upstreamGene1==1)));
v2=abs(table_to_use.deltaDeltaZ(logical(ase_idx.*qtn_idx.*(table_to_use.upstreamGene1==1))));
