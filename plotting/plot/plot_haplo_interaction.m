function [] = plot_haplo_interaction(buffer_switch,dependency_directory,output_directory)
...
v_buffer=abs(mapping_input.deltaZbuffer)>=abs(mapping_input.deltaZbaseline);
if buffer_switch==1
    mapping_input=mapping_input(v_buffer,:);
