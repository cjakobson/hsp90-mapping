function [] = plot_cumulative_effect_size(dependency_directory,output_directory)
...
for i=1:length(variant_labels)
    ...
    for j=1:length(v_bins)
        ...
        mat_to_plot(i,j)=sum(temp_data.varExp<=v_bins(j));
...
axis square
legend(variant_labels,'Location','Northwest')
